...
class Workout {
  ...
  constructor(coords, distance, duration) {
    ...
    this.distance = distance; // this should bee in km
    this.duration = duration; // this should bee in min
  }
...
class App {
  ...
  _newWorkout(e) {
    ...
    let workout;
    //if is activity running,create running object
    ...
    if (type === 'running') {
      ...
      if (
        ...
        return alert('Inputs need to be positive number!');
      }
      workout = new Running([lat, lng], distance, duration, cadance);
    }

    //if is activit cycling,create cycling object
